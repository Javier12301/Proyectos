    ...
    public partial class mdCategoria : Form
    {
        ...
        private void modificarCategoria()
        {
            if (ValidarCampos())
            {
                ...
                if (resultado)
                {
                    ...
                    {
                        if(oCategoriaPorModificar.Estado != categoria.Estado)
                        {
        ...
        private void dgvCategorias_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            try
            {
                ...
                // Botón modificar
                if (nombreColumna == "dgvcModificar")
                {
        ...
        private void dgvCategorias_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dgvCategorias.Columns[e.ColumnIndex].Name == "dgvcModificar")
                {
                ...
                if (dgvCategorias.Columns[e.ColumnIndex].Name == "dgvcEliminar")
                {
                    int indice = e.RowIndex;
                    if (indice >= 0)
                    {
