...
namespace Negocio.Seguridad
{
    public class Sesion
    {
        ...
        public CajaM _caja { get; private set; }
        ...
        public static void IniciarCaja(CajaM caja)
        {
            lock (_lock)
            {
        ...
        public static void CerrarSesion(bool cerrarCaja = false)
        {
